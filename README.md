...
<html>
    <head>
     <link rel="icon" href="oooo.img" type="image/x-icon">
  <link rel="shortcut icon" href="oooo.img" type="image/x-icon">
        <title>hazim</title>
        <meta charset="utf-8">
...
<p class="mix">A mixed border.</p<p class="dotted">A dotted border.</p>
<p class="dashed">A dashed border.</p>
<p class="solid">A solid border.</p>
<p class="double">A double border.</p>
<p class="groove">A groove border.</p>
...
<img src=" img hzim.jpg" alt="" width="400" height="300">
